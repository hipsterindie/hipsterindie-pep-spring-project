...
## 6: Our API should be able to delete a message identified by a message ID. DONE
...
## 8: Our API should be able to retrieve all messages written by a particular user. DONE
